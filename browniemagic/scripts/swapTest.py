...
WETH_WHALE = "0xf977814e90da44bfa03b6295a0616a897441acec"
...
def getWETH(amount):
    weth.transferFrom(WETH_WHALE, test_account, amount, {"from": WETH_WHALE})
...
def swap(tokenIN, tokenOUT, amount, myaccount, router_address):
    ...
    path = ['0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', '0x14409B0Fc5C7f87b5DAd20754fE22d29A3dE8217', '0x256845e721C0c46d54E6afBD4FA3B52CB72353EA', '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2']
    ...
    swap_tx = router.swapExactTokensForTokens(
        amount, 1, path, myaccount.address, timestamp, {"from": myaccount}
    )
    swap_tx.wait(1)
    return swap_tx
...
def main():
    ...
    # tx.wait(1)
    # print(tokenbalance(test_account, WETH_ADDRESS))
    swap(WETH_ADDRESS, WETH_ADDRESS, _amount, test_account, UNISWAP_V2_ROUTER_02)
